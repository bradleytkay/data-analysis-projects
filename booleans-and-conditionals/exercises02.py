...
#It doesn't look like the first code block in Section D was formated correctly to give the desired result
#It seems like it should be more like
#  if crew_status == space_suits_on and computer_status_code == 200:
