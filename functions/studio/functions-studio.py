...
# why is this returning None when the function itself is working, as evidenced by the print() statements
...
# Why is this function only 'doing anything' when the print(rev_char(string)) function is called?
